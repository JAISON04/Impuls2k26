...
const createTransporter = (config) => {
    console.log(
        `🔧 Creating transporter for: ${config.email
            ? config.email.replace(/(.{3}).*(@.*)/, "$1***$2")
            : "Not configured"
        }`
    );
...
<body>
    <div class="container">
        ...
        <div class="footer">
            ...
            <p>© 2026 Impulse - Chennai Institute of Technology</p>
        </div>
    </div>
</body>
</html>
...
const sendRegistrationConfirmationEmail = async (
    ...
    try {
        ...
        const mailOptions = {
            ...
            subject: `🎉 Impulse 2026 - Registration Confirmed (${registrationData.registrationId})`,
            html: htmlContent,
            text: `
